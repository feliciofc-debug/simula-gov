...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const isAuthed = localStorage.getItem("simula-auth") === "true";
    if (!isAuthed) {
  ...
  const pieData = result
    ? [
        ...
        {
          name: "Incremento",
          value: Math.max(0, result.cenarioNovo.riquezaTotal - result.cenarioAtual.riquezaTotal),
        },
      ]
    : [];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] px-4 py-10 text-white sm:px-6">
        ...
        <header className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-[#b3b3c7]">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/10 px-4 py-2 text-[#b3b3c7]"
            >
